...
| :------------------ | :--------------------------------------------- |
| album\_title        | Name of the album                              |
| release\_date       | Date of album release                          |
| format              | Type of release (album or single)              |
| certification       | Certification level (gold, platinum)           |
| certification\_date | Date of certification                          |
| plat\_modifer       | Number of times the album has reached platinum |
